    ...
    try {
      ...
      if (!msg) {
        const greetings = [
          ...
          "কি গো সোনা রাসেল বসকে ডেকো না জান্নাত ভাবির লগে বেস্তো আছে",
          "আমি রাসেল বস এর সাথে বেস্তো আছি আমাকে ডাকস কেন😡",
          "আহ শোনা আমার আমাকে এতো ডাক্তাছো কেনো আসো বুকে আশো🥱",
          "আসো প্রেম করি ছ্যাকা আমাকেই দিও সমস্যা নাই.😩",
          "আসসালামু আলাইকুম আমার বস রাসেল এর জন্য দোয়া করবেন",
          "আমাকে এতো না ডেকে বস রাসেল কে একটা গফ দে 🙄",
          "jang hanga korba",
          "jang bal falaba🙂"
        ];
